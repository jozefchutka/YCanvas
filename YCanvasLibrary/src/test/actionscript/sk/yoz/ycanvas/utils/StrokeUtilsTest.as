package sk.yoz.ycanvas.utils
{
    ...
    public class StrokeUtilsTest
    {
        ...
        {
            var result:VertexData = StrokeUtils.pointsToVertexData(Vector.<Number>([0, 0, 10, 0]), 10);
        ...
        {
            var result:VertexData = StrokeUtils.pointsToVertexData(Vector.<Number>([0, 0, 10, 0, 10, 10, 0, 10]), 10);
        ...
        {
            var result:VertexData = StrokeUtils.pointsToVertexData(Vector.<Number>([0, 0, 5, 0, 10, 0]), 10);
